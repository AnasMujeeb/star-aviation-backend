...
const createProductRules = [
  ...
  // ─── OPTIONAL FIX: Expiry Date Ab Required Nahi Hai ───
  body('expiryDate')
    .optional({ checkFalsy: true }) // Khali string ya null hone par allow karega
    .isISO8601()
    .withMessage('Expiry date must be a valid ISO 8601 date'),

  // ─── OPTIONAL FIX: Supplier Name Ab Required Nahi Hai ───
  body('supplier.name')
    .optional({ checkFalsy: true })
    .trim(),

  // ─── OPTIONAL FIX: Batch aur Serial Numbers ko bhi allow karega agar khali hon ───
  body('batchNumber')
    .optional({ checkFalsy: true })
    .trim(),
